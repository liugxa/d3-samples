...
//var jDependency.rave = d3;
jDependency.rave = rave;

//attached the jProgress on the windows object
window.jDependency = window.jd = jDependency;

jDependency.JDI18n = function(){
...
jDependency.JDContext = function(container, urlContext, showExcel, i18n){
	...
	/* i18n messages */	
	this.i18n = (i18n != null) ? i18n: new jd.JDI18n();
...
jDependency.JDPosition = function(context, x, y){
...
jDependency.imageOnclick = function(context, id, type){
	console.log("image on click! id:" + id, ", type:" + type);
}

jDependency.textOnclick = function(context, id){
